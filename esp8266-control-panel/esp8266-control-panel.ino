...
page +=  "<link href='https://maxcdn.bootstrapcdn.com/bootswatch/3.3.7/darkly/bootstrap.min.css' rel='stylesheet'>";
...
page +=  "</head>";
page +=  "<body>";
page +=  "<nav class='navbar navbar-inverse'>";
page +=    "<div class='container-fluid' >";
page +=    "<div class='navbar-header' >";
page +=        "<a class='navbar-brand active' href='#'>Centrum dowodzenia</a>";
page +=      "</div>";
page +=    "</div> ";
page +=     " <ul class='nav navbar-nav'>";
page +=        "<li ><a href='#'>Kominek: <strong>";
page +=   fireplaceTMP;
page +=  "&#186</strong></a></li>";
page +=        "<li><a href='#'>Pompa: <strong>";
page +=   pumpFireplace;
page +=   "&#186</strong></a></li>";
page +=        "<li><a href='#'>Histereza :<strong>";
page +=  hysteresis;
page +=   "&#186</strong></a></li>";
page +=      "</ul>";
page +=   " </div>";
...
page +=     "<span class='min-chart' id='chart-sales' data-percent='56'><span class='percent'></span></span>";
page +=  "</body>";
page +=  "</html>";
   ;
